...
public class RandomDog extends Worker {

    public RandomDog(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        try {
            ...
            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                ...
                //Выходные данные, которые будут переданы в действие
